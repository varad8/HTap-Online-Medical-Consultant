...
function DoverView() {
  ...
  const fetchVisitingStatusChart = async () => {
    try {
      const response = await axios.get(
        `${endpoint}/doctor/booking/visiting/chart/${session.id}`,
        {
          headers: {
            Authorization: `Bearer ${token}`,
          },
  ...
  const MonthlyData = async () => {
    try {
      const response = await axios.get(
        `${endpoint}/doctor/reports/monthly/${session?.id}`,
        {
          headers: {
            Authorization: `Bearer ${token}`,
          },
  ...
  const WeeklyData = async () => {
    try {
      const response = await axios.get(
        `${endpoint}/doctor/reports/weekly/${session?.id}`,
        {
          headers: {
            Authorization: `Bearer ${token}`,
          },
  ...
  const YearlyData = async () => {
    try {
      const response = await axios.get(
        `${endpoint}/doctor/reports/yearly/${session?.id}`,
        {
          headers: {
            Authorization: `Bearer ${token}`,
          },
