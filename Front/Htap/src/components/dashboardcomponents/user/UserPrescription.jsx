  ...
  const fetchPrescriptionData = async () => {
    try {
      const response = await axios.get(
        `${endpoint}/users/prescriptions/${session.id}`,
        {
          headers: {
  ...
  const saveRatings = async () => {
    ...
    try {
      const response = await axios.post(
        `${endpoint}/users/notification/save`,
        {
          notification_title: title,
          feedback_message: content,
          pid: selectedPres.pid,
          d_id: selectedPres.d_id,
          patient: selectedPres.patient._id,
          doctor: selectedPres.doctor._id,
          ratings: rating,
        },
        {
          headers: {
            ...
            filteredData.map((prescription) => (
              ...
              >
                ...
                <div className="bg-gray-50 py-2 justify-between flex gap-2 px-2">
                  ...
                  <button
                    onClick={() => handleRate(prescription)}
                    type="button"
