...
function UserOverView() {
  ...
  const fetchBookingChart = async () => {
    try {
      const response = await axios.get(
        `${endpoint}/users/booking/chart/${session.id}`,
        {
          headers: {
  ...
  const fetchPrescriptionChart = async () => {
    try {
      const response = await axios.get(
        `${endpoint}/users/prescriptions/chart/${session.id}`,
        {
          headers: {
            Authorization: `Bearer ${token}`,
          },
  ...
  const fetchPaymentChart = async () => {
    try {
      const response = await axios.get(
        `${endpoint}/users/payment/chart/${session.id}`,
        {
          headers: {
            Authorization: `Bearer ${token}`,
          },
  ...
  const fetchVisitingStatusChart = async () => {
    try {
      const response = await axios.get(
        `${endpoint}/users/booking/visiting/chart/${session.id}`,
        {
          headers: {
            Authorization: `Bearer ${token}`,
          },
  ...
  const chartData = {
    ...
    datasets: bookingChart.map((doctorData, index) => ({
      ...
      borderWidth: 1,
      data: [doctorData.data], // Wrap data in an array if it's not already an array
    })),
  };
  ...
  const MonthlyData = async () => {
    try {
      const response = await axios.get(
        `${endpoint}/users/reports/monthly/${session?.id}`,
        {
          headers: {
            Authorization: `Bearer ${token}`,
          },
  ...
  const WeeklyData = async () => {
    try {
      const response = await axios.get(
        `${endpoint}/users/reports/weekly/${session?.id}`,
        {
          headers: {
            Authorization: `Bearer ${token}`,
          },
  ...
  const YearlyData = async () => {
    try {
      const response = await axios.get(
        `${endpoint}/users/reports/yearly/${session?.id}`,
        {
          headers: {
            Authorization: `Bearer ${token}`,
          },
